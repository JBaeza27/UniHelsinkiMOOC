...
public class SportStatistics {
    ...
    public static void main(String[] args) {
        ...
        for (Game totalgame : games) {
            if (team.equals(totalgame.getHomeTeam()) || team.equals(totalgame.getOpponent())) {
                gamesOfATeam.add(totalgame);
            }
        }
        ...
        int wins = 0;
        for (Game turnoutgame : gamesOfATeam) {
            if (turnoutgame.winnerIs(team)) {
                wins++;
            }
        }
